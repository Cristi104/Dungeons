...
//    std::cout << testEntity;
//    std::cout << Settings::getInstance()->getScaleWidth() << ' ' << Settings::getInstance()->getScaleHeight() << '\n';
//    std::cout << Settings::getInstance()->getResolutionWidth() << ' ' << Settings::getInstance()->getResolutionHeight() << '\n';
//    std::cout <<sizeof (Border);
...
////        component.draw(window.getWindow());
////        window.getWindow().draw(sprite);
////        testPanel.draw(window.getWindow());
//        FightScreen::getInstance()->draw(window.getWindow());
